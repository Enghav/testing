...
const Home = () => {
    ...
    return (
    <div >
      <div class="w-[1000px] h-[620px] rounded-[20px] " style={ColorChange}>
        <div className="flex justify-between m-4 mt-2 mb-0">
          ...
          <span className="w-[55px] h-[25px]  bg-amber-200 rounded-[5px] shadow flex justify-center items-center cursor-pointer hover:scale-110">
            <div class="text-zinc-950 text-[13px] font-normal font-['Inika'] ">
              {" "}
              PRO
            </div>
            <span className=" translate-x-[2px]">
              ...
              >
                <path
                  id="Vector"
                  d="M1 12.25L11.5 1L9.25 9.25H17.5L7 20.5L9.25 12.25H1Z"
                  stroke="black"
                  stroke-width="1.5"
